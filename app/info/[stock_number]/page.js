...
import {StockBasicInfo, StockCompInfo, StockBalSheet, StockTradingInfo, StockChart} from '@/components/stock_number/stockBasicInfo';
...
export default function StockInfoPage({params: {stock_number}}) {
    ...
    return (
        <Container fluid className="py-5 mw-100 w-100 h-100 mx-0">
            <div className="row w-100 h-100 ">
                <main className="h-100 col-md-9 ml-sm-auto col-lg-9 px-md-4 px-lg-5 d-flex flex-column">
